...
export function OrderImportPage() {
  ...
  return (
    <CsvImportPage
      ...
      format={[t('orderImport.formatRows'), t('orderImport.formatRequired'), t('orderImport.formatOptional'), t('orderImport.formatPrices'), t('orderImport.formatAgain')]}
      template={{
        filename: 'orders.csv',
        rows: [
          ['orderReference', 'customerName', 'customerEmail', 'shippingLine1', 'shippingPostalCode', 'shippingCity', 'shippingCountry', 'sku', 'quantity', 'unitPrice'],
          ['WEB-1001', 'Anna Andersson', 'anna@example.com', 'Storgatan 1', '111 22', 'Stockholm', 'SE', 'TEE-BLK-M', '2', '199.00'],
