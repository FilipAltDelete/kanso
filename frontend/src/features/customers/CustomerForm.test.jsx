...
describe('the customer form', () => {
  ...
  it('shows what the API refused next to the field it names', async () => {
      ...
      'POST /api/customers': {
        ...
        body: {
          ...
          violations: [
            ...
            { path: 'addresses[0].postalCode', message: 'This field is required.', code: 'required' },
    ...
    expect(within(screen.getByRole('group', { name: 'Leveransadress 1' })).getByText('Fältet är obligatoriskt.')).toBeTruthy();
  });
