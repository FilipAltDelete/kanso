...
// The same preparation the core's own suite gets. It moves into a published
// test kit once the core has one (Pimsen's pimsen/core-tests).
...
// The core's migrations and the project's own; a no-op when the schema is current.
passthru(sprintf(
