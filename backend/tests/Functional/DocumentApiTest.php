...
final class DocumentApiTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // Order lines are for products, and an order ships from a location.
        ...
        foreach (['TSHIRT-M' => 'T-shirt, M', 'SOCKS' => 'Strumpor'] as $sku => $name) {
            $product = $catalog->createProduct($sku, $name, null, null);
            // Enough that confirming, which reserves, never runs short.
